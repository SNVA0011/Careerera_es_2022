                ...
                <div className="row text-gray-700 align-items-center text-center">
                    <div className="col-12">
                        ...
                        <p className="font-semibold text-white text-sm sm:text-base mb-0 linktitle-batch">
                            {props.batch ? <span className='text-yellow-400 align-middle d-inline-block'>{props.batch} </span>  : ''}
                            {props.detail ? <span className="text-yellow-400 align-middle d-inline-block">{}</span> : ''}
                        </p>
                    </div>
